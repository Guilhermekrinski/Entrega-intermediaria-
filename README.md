...
## 🧾 Avaliação (Tabela de Pontos)

| Critério | Pontos | Descrição |
|-----------|---------|-----------|
| Cadastro de Clientes | 1.5 | Sistema permite cadastrar, consultar, buscar e excluir clientes. |
| Cadastro de Pets | 1.5 | Sistema permite cadastrar, consultar, buscar e excluir pets. |
| Cadastro de Serviços | 1.5 | Sistema permite cadastrar, consultar, buscar e excluir serviços. |
| Cadastro de Pacotes | 1.5 | Sistema permite cadastrar, consultar, buscar e excluir pacotes. |
| Organização e Qualidade do Código | 1.0 | Estrutura limpa e uso correto de POO. |
| Validação | 1.0 | Verificação de tipo, obrigatoriedade e tamanho de dados. |
| Regras de Negócio | 1.0 | Implementadas conforme especificação. |
| Manual e Documentação | 1.0 | README completo com descrição e instruções. |
